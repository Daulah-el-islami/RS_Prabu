...
public class F_Obat extends javax.swing.JFrame {
    ...
    /**
     * Creates new form F_Obat
     */
    public F_Obat() {
        initComponents();
        this.setLocationRelativeTo(null);
        String[] judul = {"Kode Obat", "Nama Obat", "Dosis", "Harga"};
    ...
    private void initComponents() {
        ...
        e_kd_obat = new javax.swing.JTextField();
        ...
        e_dosis = new javax.swing.JTextField();
        ...
        e_kd_obat.setEditable(false);
        e_kd_obat.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        e_kd_obat.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 10, 1, 1));
        e_kd_obat.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        e_kd_obat.setMargin(new java.awt.Insets(0, 3, 0, 3));
        e_kd_obat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                e_kd_obatKeyTyped(evt);
            }
        });
        getContentPane().add(e_kd_obat, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 96, 30));

        e_namaobat.setEditable(false);
        ...
        e_namaobat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                e_namaobatKeyTyped(evt);
            }
        });
        getContentPane().add(e_namaobat, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, 250, 30));
        ...
        jTable1.setPreferredSize(new java.awt.Dimension(1014, 68));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, 1020, 170));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 260, 40));
        ...
        jLabel13.setText(":");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 10, -1));

        e_harga.setEditable(false);
        ...
        e_harga.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                e_hargaActionPerformed(evt);
            }
        });
        e_harga.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                e_hargaKeyTyped(evt);
            }
        });
        getContentPane().add(e_harga, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 220, 250, 30));
        ...
        e_dosis.setEditable(false);
        e_dosis.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        e_dosis.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 10, 1, 1));
        e_dosis.setMargin(new java.awt.Insets(0, 3, 0, 3));
        e_dosis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                e_dosisActionPerformed(evt);
            }
        });
        e_dosis.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                e_dosisKeyTyped(evt);
            }
        });
        getContentPane().add(e_dosis, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 250, 30));
    ...
    private void e_kd_obatKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_e_kd_obatKeyTyped
        FilterHanyaAngka(evt);
        String batas = e_kd_obat.getText();
        if (batas.length() >= 11) {
            evt.consume();
        }
    }//GEN-LAST:event_e_kd_obatKeyTyped

    private void e_namaobatKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_e_namaobatKeyTyped
        FilterHanyaHuruf(evt);
        String batas = e_namaobat.getText();
        if (batas.length() >= 150) {
            evt.consume();
        }
    }//GEN-LAST:event_e_namaobatKeyTyped

    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        e_kd_obat.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
        e_namaobat.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString());
        e_dosis.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString());
        e_harga.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString());

        temp_kd_obat = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        e_kd_obat.requestFocus();
    }//GEN-LAST:event_tambahActionPerformed

    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        if (fungsi_simpan == true && fungsi_ubah == false) {
            if (e_kd_obat.getText().isEmpty() || e_namaobat.getText().isEmpty() || e_dosis.getText().isEmpty() || e_harga.getText().isEmpty()) {
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        if (e_kd_obat.getText().isEmpty()) {
            ...
            int reply = JOptionPane.showConfirmDialog(this, "Hapus Data Obat ?", "Warning", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    private void e_hargaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_e_hargaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_e_hargaActionPerformed

    private void e_hargaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_e_hargaKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_e_hargaKeyTyped
    ...
    private void e_dosisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_e_dosisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_e_dosisActionPerformed

    private void e_dosisKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_e_dosisKeyTyped

    }//GEN-LAST:event_e_dosisKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Obat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField e_dosis;
    private javax.swing.JTextField e_harga;
    private javax.swing.JTextField e_kd_obat;
    ...
    private void enable_field() {
        e_kd_obat.setEditable(true);
        e_namaobat.setEditable(true);
        e_dosis.setEditable(true);
        e_harga.setEditable(true);
    }
    ...
    private void cek_double_data_simpan() {
        try {
            ...
            ResultSet re = con.createStatement().executeQuery("select * from obat where kd_resep = '" + e_kd_obat.getText() + "'");
            if (re.next()) {
    ...
    private void cek_double_data_ubah() {
        try {
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("select * from obat where kd_resep != '" + temp_kd_obat + "' AND kd_resep='" + e_kd_obat.getText() + "'");
            if (re.next()) {
    ...
    private void fungsi_simpan_data() {
        try {
            con = Koneksi.getKoneksi();
            con.createStatement().executeUpdate("INSERT INTO obat VALUES('" + e_kd_obat.getText() + "'"
                    + ",'" + e_namaobat.getText() + "','" + e_dosis.getText() + "','" + e_harga.getText() + "')");
    ...
    private void fungsi_ubah_data() {
        try {
            con = Koneksi.getKoneksi();
            con.createStatement().executeUpdate("UPDATE obat SET kd_resep='" + e_kd_obat.getText() + "'"
    ...
    private void tampil() {
        try {
            ...
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM obat ORDER BY kd_resep");
            while (re.next()) {
    ...
    private void penomoran_otomatis() {
        ...
        try {
            ...
            while (res.next()) {
                ...
                String nomor_blkg = temp_kode_obat.substring(3, 5);
                no_kode_obat = Integer.parseInt(nomor_blkg);
            }

            no_kode_obat++;
            String nilai = String.valueOf(no_kode_obat);
            if (nilai.length() == 1) {
                e_kd_obat.setText("OB00" + no_kode_obat);
            } else if (nilai.length() == 2) {
                e_kd_obat.setText("OB0" + no_kode_obat);
            } else if (nilai.length() == 3) {
                e_kd_obat.setText("OB" + no_kode_obat);
            }
    ...
    private void fungsi_pencarian() {
        try {
            ...
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM obat where kd_resep LIKE '%" + pencarian.getText() + "%'"
    ...
    private void aturFokus() {
        e_kd_obat.setNextFocusableComponent(e_namaobat);
        e_namaobat.setNextFocusableComponent(e_dosis);
        e_dosis.setNextFocusableComponent(e_dosis);
    }
