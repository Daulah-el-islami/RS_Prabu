...
public class F_Pasien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 200, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Pasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void cek_double_data_simpan() {
        try {
            ResultSet re = con.createStatement().executeQuery("select * from pasien where kd_pasien = '" + e_idpasien.getText() + "'");
            if (re.next()) {
    ...
    private void cek_double_data_ubah() {
        try {
            ResultSet re = con.createStatement().executeQuery("select * from pasien where kd_pasien != '" + temp_kd_pasien + "' AND kd_pasien='" + e_idpasien.getText() + "'");
            if (re.next()) {
    ...
    private void fungsi_simpan_data() {
        try {
            con.createStatement().executeUpdate("INSERT INTO pasien VALUES('" + e_idpasien.getText() + "'"
    ...
    private void fungsi_ubah_data() {
        try {
            con.createStatement().executeUpdate("UPDATE pasien SET kd_pasien='" + e_idpasien.getText() + "'"
    ...
    private void tampil() {
        try {
            ...
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM pasien ORDER BY kd_pasien");
            while (re.next()) {
    ...
    private void fungsi_pencarian() {
        try {
            ...
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM pasien where kd_pasien LIKE '%" + pencarian.getText() + "%'"
