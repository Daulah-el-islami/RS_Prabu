...
public class F_Perawat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 1020, 180));
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "Eror:" + ex, "Gagal", JOptionPane.WARNING_MESSAGE);
                    }
                }
                empty_field();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Perawat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void cek_double_data_simpan() {
        try {
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("select * from perawat where kd_perawat = '" + e_idperawat.getText() + "'");
            if (re.next()) {
    ...
    private void cek_double_data_ubah() {
        try {
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("select * from perawat where kd_perawat != '" + temp_kd_perawat + "' AND kd_perawat='" + e_idperawat.getText() + "'");
            if (re.next()) {
    ...
    private void fungsi_simpan_data() throws SQLException {
        con = Koneksi.getKoneksi();
        con.createStatement().executeUpdate("INSERT INTO perawat VALUES('" + e_idperawat.getText() + "'"
    ...
    private void fungsi_ubah_data() throws SQLException {
        con = Koneksi.getKoneksi();
        con.createStatement().executeUpdate("UPDATE perawat SET kd_perawat='" + e_idperawat.getText() + "'"
    ...
    private void tampil() {
        try {
            ...
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM perawat ORDER BY kd_perawat");
            while (re.next()) {
    ...
    private void fungsi_pencarian() {
        try {
            ...
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM perawat where kd_perawat LIKE '%" + pencarian.getText() + "%'"
