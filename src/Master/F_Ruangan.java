...
public class F_Ruangan extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Ruangan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void cek_double_data_simpan() {
        try {
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("select * from ruangan where kd_ruangan = '" + e_kdruangan.getText() + "'");
            if (re.next()) {
    ...
    private void cek_double_data_ubah() {
        try {
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("select * from ruangan where kd_ruangan != '" + temp_kd_ruangan + "' AND kd_ruangan='" + e_kdruangan.getText() + "'");
            if (re.next()) {
    ...
    private void fungsi_simpan_data() throws SQLException {
        con = Koneksi.getKoneksi();
        con.createStatement().executeUpdate("INSERT INTO ruangan VALUES('" + e_kdruangan.getText() + "'"
    ...
    private void fungsi_ubah_data() throws SQLException {
        con = Koneksi.getKoneksi();
        con.createStatement().executeUpdate("UPDATE ruangan SET kd_ruangan='" + e_kdruangan.getText() + "'"
    ...
    private void tampil() {
        try {
            ...
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM ruangan ORDER BY kd_ruangan");
            while (re.next()) {
    ...
    private void fungsi_pencarian() {
        try {
            ...
            con = Koneksi.getKoneksi();
            ResultSet re = con.createStatement().executeQuery("SELECT * FROM ruangan where kd_ruangan LIKE '%" + pencarian.getText() + "%'"
    ...
    private void hitungData() {
        ...
        jumlah_data.setText(String.format("%04d", total_baris)); // Menggunakan format String untuk memastikan panjang 4 digit
    }
}
